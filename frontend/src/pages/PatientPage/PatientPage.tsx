...
import { getUnsignedMedia, sendSignDocument } from '../../redux/reducers/userReducer/userReducer';
  ...
  return (
    <Stack direction="row" justifyContent={'space-between'} padding="0 100px">
      ...
      <Stack spacing={1}>
        ...
        <Button variant="contained" onClick={startQuiz} disabled={!!questions}>Пройти опрос</Button>
        <Stack gap={1}>
